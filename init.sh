...
./rapidd add-genesis-account $KEY 100000000000000000000000000000arapid --keyring-backend $KEYRING

# Sign genesis transaction
./rapidd gentx $KEY 10000000000000000000000arapid --keyring-backend $KEYRING --chain-id $CHAINID
